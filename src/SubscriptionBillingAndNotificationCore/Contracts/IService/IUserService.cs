...
namespace SubscriptionBillingAndNotificationCore.Contracts.IService
{
    public interface IUserService
    {
        ...
        Task<BaseResponse<UserResponseDto>> GetUserById(long id, CancellationToken cancellationToken);
        Task<BaseResponse<string>> DeleteUser(long id, CancellationToken cancellationToken);
        Task<BaseResponse<UserResponseDto>> UpdateUser(UpdateUserRequestDto request, CancellationToken cancellationToken);
    }
}
